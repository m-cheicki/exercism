...
def preparation_time_in_minutes(number_of_layers: int) -> int: 
    ...
    Function that takes the number of layers wanted to make the lasagna as an argument
    and returns how many minutes it will take to prepare them, based on the `PREPARATION_TIME`. 
    """
